...
<head>
    ...
    <title>Dropshipping Marketplace</title>
...
<body>
    ...
    <script type="text/babel">
            ...
            return (
                <div className="min-h-screen flex items-center justify-center bg-gray-50">
                    <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow">
                        <h2 className="text-2xl font-bold text-center">Vendor Portal</h2>
        ...
        const VendorProfile = () => {
            ...
            React.useEffect(() => {
                if (user) {
                    db.collection('vendors').doc(user.uid).get().then(doc => {
                        if (doc.exists) {
                            setProfile(doc.data());
                        }
                    });
            ...
            const handleUpdate = async (e) => {
                ...
                try {
                    ...
                    if (file) {
                        photoURL = await uploadFile(file, `vendor_profiles/${user.uid}`);
                    }
                ...
                <div className="max-w-2xl mx-auto p-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <input
                            ...
                            placeholder="Delivery Time Estimate"
                            className="w-full p-2 border rounded"
                        />
                        <textarea
        ...
        const App = () => {
            ...
            return user ? <VendorDashboard /> : <Login />;
        };
